...
void Background::show(sf::RenderWindow& rw, int op1, int op2, int op3)
{
	...
	if (op1 == 1)
		texture[0].loadFromFile("images/1-1.png");
	else
		texture[0].loadFromFile("images/1-2.png");

	if (op2 == 1)
		texture[1].loadFromFile("images/2-1.png");
	else
		texture[1].loadFromFile("images/2-2.png");

	if (op3 == 1)
		texture[2].loadFromFile("images/3-1.png");
	else
		texture[2].loadFromFile("images/3-2.png");
