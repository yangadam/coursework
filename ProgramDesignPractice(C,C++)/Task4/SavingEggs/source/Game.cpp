...
void Game::start(sf::RenderWindow& rw)
{
	...
	Cook* pcook[9] = {new Cook("media/images/wait.png"), new Cook("media/images/wait.png"), new Cook("media/images/wait.png"),
		new Cook("media/images/good.png"),new Cook("media/images/good.png"),new Cook("media/images/good.png"),
		new Cook("media/images/bad.png"),new Cook("media/images/bad.png"),new Cook("media/images/bad.png"),};
...
void Game::gameLoop(sf::RenderWindow& rw)
{
	...
	case Game::Playing:
		{
			sf::Texture texture;
			texture.loadFromFile("media/images/pause-button.png");
	...
	case Paused:
		{
			sf::Texture texture;
			texture.loadFromFile("media/images/pause.png");
			sf::Sprite sprite(texture);
			rw.draw(sprite);
			rw.display();
				if(currentEvent.type == sf::Event::KeyPressed 
	...
	case GameOver:
		{
			...
			(_eggs.get("egg2"))->setPosition(400, -rand()%200-10);
			sf::Texture texture;
			texture.loadFromFile("media/images/lose.png");
			sf::Sprite sprite(texture);
			rw.draw(sprite);
			rw.display();
			if(currentEvent.type == sf::Event::KeyPressed 
	...
	case Win:
		{
			sf::Texture texture;
			texture.loadFromFile("media/images/score.png");
			sf::Sprite sprite(texture);
			rw.draw(sprite);
			_score.draw(rw);
			rw.display();
	...
	case Help:
		{
			sf::Texture texture;
			texture.loadFromFile("media/images/help0.png");
			sf::Sprite sprite(texture);
			rw.draw(sprite);
			rw.display();
			if(currentEvent.type == sf::Event::KeyPressed 
