	...
	case Game::Playing:
		{
			...
			{
				texture.loadFromFile("images/Darkgrey.png");
...
void Game::showSplashScreen(sf::RenderWindow& rw)
{
	...
	splashScreen.show(rw, "images/SplashScreen.png");
...
{
	Menu mainMenu;
	Menu::MenuResult result = mainMenu.show(rw, "images/mainmenu.png");
	switch(result)
	{
	case Menu::Button1:
		_bricks.initialize();
...
{
	Menu settingMenu;
	Menu::MenuResult result = settingMenu.show(rw, "images/settings.png");
...
void Game::showHelping(sf::RenderWindow& rw)
{
	...
	helpingScreen.show(rw, "images/help.png");
	_gameState = Game::ShowingMainMenu;
}
...
void Game::showPausedScreen(sf::RenderWindow& rw)
{
	...
	pausedScreen.show(rw, "images/pause.png");
	_clock.restart();
	_gameState = Playing;
}
