...
$.extend($.fn.dataTableExt.oPagination, {
    "bootstrap": {
        "fnInit": function (oSettings, nPaging, fnDraw) {
            ...
            $(nPaging).addClass("pagination").append("<ul>" + '<li class="prev disabled"><a href="#">&larr; <span class="hidden-480">' + oLang.sPrevious + "</span></a></li>" + '<li class="next disabled"><a href="#"><span class="hidden-480">' + oLang.sNext + "</span> &rarr; </a></li>" + "</ul>");
            var els = $("a", nPaging);
