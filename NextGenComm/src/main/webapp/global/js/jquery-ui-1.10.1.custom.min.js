    ...
    e.widget("ui.sortable", e.ui.mouse, {
        ...
        _contactContainers: function (t) {
            ...
            if (this.containers.length === 1) {
                ...
                i = 10000, s = null, o = this.containers[h].floating ? "left" : "top", u = this.containers[h].floating ? "width" : "height", a = this.positionAbs[o] + this.offset.click[o];
...
(function (e, t) {
    ...
    e.extend(s.prototype, {
        ...
        iso8601Week: function (e) {
            ...
            return n.setDate(n.getDate() + 4 - (n.getDay() || 7)), t = n.getTime(), n.setMonth(0), n.setDate(1), Math.floor(Math.round((t - n) / 86400000) / 7) + 1
        },
                ...
                if (y) {
                    ...
                    switch (t.charAt(i)) {
                        ...
                        case"@":
                            ...
                            break;
                        case"!":
                            b = new Date((E("!") - this._ticksTo1970) / 10000), d = b.getFullYear(), v = b.getMonth() + 1, m = b.getDate();
                            break;
                        case"'":
                            w("'") ? x() : y = !0;
                            break;
...
jQuery.effects || function (e, t) {
    ...
    e.effects = {effect: {}}, function (e, t) {
        ...
        f.style.cssText = "background-color:rgba(1,1,1,.5)", a.rgba = f.style.backgroundColor.indexOf("rgba") > -1, c(o, function (e, t) {
            ...
            return o === s ? l = 0 : t === s ? l = 60 * (n - r) / u + 360 : n === s ? l = 60 * (r - t) / u + 120 : l = 60 * (t - n) / u + 240, u === 0 ? c = 0 : f <= 0.5 ? c = u / a : c = u / (2 - a), [Math.round(l) % 360, c, f, i == null ? 1 : i]
