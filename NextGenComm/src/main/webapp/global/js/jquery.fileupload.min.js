(function (factory) {
    if (typeof define === "function" && define.amd) {
        define(["jquery", "jquery.ui.widget.min.js"], factory)
    } else {
    ...
    $.widget("blueimp.fileupload", {
        ...
        _initXHRData: function (options) {
            var formData, file = options.files[0], multipart = options.multipart || !$.support.xhrFileUpload, paramName = options.paramName[0];
        ...
        _onPaste: function (e) {
            var cbd = e.originalEvent.clipboardData, items = (cbd && cbd.items) || [], data = {files: []};
