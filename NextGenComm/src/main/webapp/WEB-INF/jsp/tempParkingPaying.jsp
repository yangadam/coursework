...
<div class="page-container">
    ...
    <script type="text/javascript" src="../../custom/js/select2.min.js"></script>
    <script type="text/javascript" src="../../custom/js/jquery.dataTables.js"></script>
    <script type="text/javascript" src="../../custom/js/DT_bootstrap.js"></script>

    <!-- END PAGE LEVEL PLUGINS -->
    <!-- BEGIN PAGE LEVEL SCRIPTS -->
    <script src="../../custom/js/app.js"></script>
    <script src="../../custom/js/tempParkingPaying.js"></script>
    <script>
        jQuery(document).ready(function () {
            App.init();
            TableEditable.init();
            $(".page-sidebar-menu .title:contains('缴费单')").closest(
                    "li").addClass("active");
        });
    </script>
    <!-- END JAVASCRIPTS -->
