                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑社区信息</div>
                            <div class="tools">
                                ...
                                <div class="row-fluid">
                                    <div class="span6 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <s:textfield name="commName" value="%{comm.name}"
                                                             cssClass="m-wrap span12"
                                                             placeholder="请填写社区名"/>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="span3 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <s:textfield cssClass="m-wrap span12" value="%{comm.id}"
                                                             readonly="true"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-actions">
                                        <s:submit cssClass="btn green" value="保存"/>
