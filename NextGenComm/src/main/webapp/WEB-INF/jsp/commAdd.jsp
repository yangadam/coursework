                                ...
                                <div class="row-fluid">
                                    <div class="span12 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <s:textfield name="commName" cssClass="m-wrap span5"
                                                             placeholder="请填写社区名"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <s:textfield cssClass="m-wrap span5" placeholder="请填写社区地址"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <s:textfield class="m-wrap span5" placeholder="请填写物业公司"/>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <div class="input-append date date-picker m-wrap span12"
                                                         data-data="25-12-2014"
