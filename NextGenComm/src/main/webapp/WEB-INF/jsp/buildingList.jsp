            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li>
                            <a href="../admin/buildingList.do">楼宇列表</a>
                        </li>
                    </ul>
                ...
                <div class="span12">
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            <div class="clearfix">
                                <div class="btn-group">
                                    <a href="../admin/buildingAdd.do?comm.id=${comm.id}" id="sample_editable_1_new"
                                       class="btn green">
...
<script src="../../pumpking/js/json/buildingList.js"></script>
<script>
