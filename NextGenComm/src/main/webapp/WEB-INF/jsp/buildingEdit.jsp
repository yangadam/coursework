                ...
                <div class="span12">
                    ...
                    <div class="portlet box blue">
                        <div class="portlet-title">
                            <div class="caption"><i class="icon-reorder"></i>编辑楼宇信息</div>
                            <div class="tools">
                                ...
                                <div class="row-fluid">
                                    <div class="span12 ">
                                        <div class="control-group">
                                            ...
                                            <div class="controls">
                                                <s:textfield value="%{building.name}" cssClass="m-wrap span5"
                                                             placeholder="请填写楼宇名"/>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row-fluid">
                                        <div class="span12 ">
                                            <div class="control-group">
                                                ...
                                                <div class="controls">
                                                    <s:textfield value="%{building.no}" cssClass="m-wrap span12"
                                                                 placeholder="请填写楼宇编号"/>
                                                </div>
                                            </div>
                                        </div>
